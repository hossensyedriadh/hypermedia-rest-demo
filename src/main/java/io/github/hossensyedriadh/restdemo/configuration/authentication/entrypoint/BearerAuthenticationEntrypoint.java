package io.github.hossensyedriadh.restdemo.configuration.authentication.entrypoint;
...
public class BearerAuthenticationEntrypoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException {
        ...
        response.setHeader(HttpHeaders.DATE, String.valueOf(Date.from(Instant.now(Clock.system(ZoneId.systemDefault())))));
